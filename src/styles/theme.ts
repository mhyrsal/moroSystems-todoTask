...
export const getShadow = (size: keyof typeof theme.boxShadow) => {
...
export const getScreen = (size: keyof typeof theme.screens) => {
    return theme.screens[size];
};

export const getDuration = (duration: keyof typeof theme.transitionDuration) => {
    return theme.transitionDuration[duration];
};
